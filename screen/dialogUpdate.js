...
export default class dialogUpdate extends Component {
    ...
    _updateProduct = () => {
        ...
        firebase.database().ref('app').child('product').child(this.props.route.params.uid).set({
    ...
    render() {
        ...
        // const { uid, name, image, status } = route.params;
        ...
        return (
            ...
            <View style={styles.dialog}>
                <View style={{ flexDirection: 'row', width: '100%', justifyContent: 'space-between' }}>
                    ...
                    <TouchableOpacity onPress={() => { this._updateProduct() }}>
                        <View style={styles.btnDang}>
                            <Text style={{ fontSize: 20, textAlign: 'center', color: 'red' }}>Lưu</Text>
                        </View>
                    </TouchableOpacity></View>
                <Text Thêm style={{ fontSize: 25, left: 15, bottom: 10 }}>Cập nhật trạng thái </Text>
                <ScrollView>
                    <View style={{ flexDirection: 'column', width: '100%', alignItems: 'center', }}>
                        <View style={styles.box3}>

                            <TextInput style={styles.inpT} placeholder={'Tiêu đề.....'}
